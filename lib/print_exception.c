...
void print_exception_infos(exc_frame_t *frame, const char *exception_name,
			   ...
			   bool is_prefetch_abort, unsigned int data_fault_status_register,
			   unsigned int data_fault_address_register,
			   unsigned int instruction_fault_status_register,
			   unsigned int instruction_fault_address_register, unsigned int cpsr,
			   ...
			   unsigned int undefined_spsr, unsigned int supervisor_spsr)
{
	...
	if (is_prefetch_abort) {
		const char *ifsr_description =
			get_fsr_description(instruction_fault_status_register);
