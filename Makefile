...
SRC = arch/cpu/entry.S kernel/start.c arch/bsp/yellow_led.c lib/ubsan.c lib/mem.c arch/bsp/uart.c lib/alib.c lib/kprintf.c arch/cpu/interrupt_vector_table.S arch/cpu/interrupts.c lib/print_exception.c 
